...
class fuckoff(vbu.Cog):
    ...
    @vbu.commands(pass_context=True, name="foff", aliases=["fuckoff"])
    ...
    @vbu.commands(pass_context=True, name="afoff", aliases=["anonymousfoff", "afuckoff", "anonymousfuckoff"])
    ...
    @vbu.commands(pass_context=True, name="ifoff", aliases=["itemfoff", "ifuckoff", "itemfuckoff"])
    ...
    @vbu.commands(pass_context=True, name="iafoff", aliases=["itemafoff", "iafuckoff", "ianonymousfuckoff", "itemanonymousfoff", "itemanonymousfuckoff"])
